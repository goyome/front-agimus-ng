...
<?php ob_start () ?>
<li class="active"><a href="/admin/index.php">Accueil <span class="sr-only">Accueil</span></a></li>
...
<?php ob_start () ?>
<p> Utilisez le menu de droite pour accéder aux différentes rubriques de l'administration </p>
